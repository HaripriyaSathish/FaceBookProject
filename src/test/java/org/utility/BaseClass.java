...
public class BaseClass {
    ...
    //4
    public static void fillText(WebElement w,String value) {
		w.sendKeys(value);
    ...
    public static void takeScreenshot(String pathname) throws IOException {
    	...
    	File des = new File("C:\\Users\\Haripriya\\eclipse-workspace\\FacebookCucumber\\target\\Screenshot\\"+pathname+".png");
